...
public class LoginSteps {
    ...
    public void validarMensajeDeErrorContasenaincorrecta() {
        Assert.assertTrue(loginPage.obtenerMensajeError().contains("Username and password do not match"));
    }
    ...
    public void validarCamposObligatorios() {
        Assert.assertTrue(loginPage.obtenerMensajeError().contains("Username is required"));
    }
}
